...
def create_bottleneck_file(bottleneck_path, image_lists, label_name, index,
  ...
  with open("features.txt", 'a+') as features_file:
    features_file.write(bottleneck_string)
    features_file.write("," + label_name)
    features_file.write("\n")
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='./tmp/retrain/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='./tmp/retrain/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='./tmp/retrain/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='./tmp/retrain/retrain_logs',
